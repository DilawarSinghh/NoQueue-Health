...
const steps = [
  {
    ...
    text:  "Tell us what you need — discharge summary, insurance forms, or a full intake.",
  },
  {
    icon:  Users,
    title: "Get matched",
    text:  "Connect with a vetted documentation agent, or let our AI Agent guide you.",
  },
  {
    icon:  FileText,
    title: "Done",
    text:  "Review, confirm, and your documentation is ready — often in minutes.",
  },
];

export function LandingPageClient({ deleted }: { deleted: boolean }) {
  return (
      ...
      <section className="mx-auto max-w-5xl px-4 pb-12 pt-16 text-center">
        ...
        >
          <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
            ...
            Hospital documentation, made simple
          </span>
